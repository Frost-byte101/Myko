...
import com.example.watcher.ProcessActivity;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("startTime",tasks.get(pos).getStarttime());
                intent.putExtra("endTime",tasks.get(pos).getEndtime());
        ...
        ImageView image = view1.findViewById(R.id.doimg);
        ...
        switch (num){
            ...
            case 2:
                ...
                break;
            case 3:
                image.setImageResource(R.drawable.cleanroom);
                break;
            case 4:
                image.setImageResource(R.drawable.pandastudy);
                break;
            case 5:
